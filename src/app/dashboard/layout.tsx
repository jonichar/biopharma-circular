...
// Context to share profile info with child pages
export const DashboardContext = createContext<{ profile: Profile | null }>({
  profile: null,
});
...
const getNavItems = (role: string) => {
  ...
  const principal = [
    { href: "/dashboard", icon: LayoutDashboard, label: "Resumen" },
    {
      ...
      icon: Package,
      label: isGestor ? "Residuos Asignados" : "Mis Residuos",
    },
  ];

  // Gestores don't see the "Gestores" link (they ARE the gestor)
  if (!isGestor) {
    principal.push({
  ...
  return [
    { section: "Principal", links: principal },
    {
      section: "Análisis",
      links: [
...
export default function DashboardLayout({
  ...
  const navItems = getNavItems(profile?.role || "person");
